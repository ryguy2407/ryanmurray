...
@section('content')
    ...
    <div class="pt-5">
        ...
        <div class="row">
            <div class="col">
                <img src="/img/elliot-theo.jpg" style="width: 100%;" class="mb-5 rounded mx-auto d-block">
            </div>
            <div class="col">
                <img src="/img/wedding.jpg" style="width: 100%;" class="mb-5 rounded mx-auto d-block">
            </div>
            <div class="col">
                <img src="/img/milly.jpg" style="width: 100%;" class="mb-5 rounded mx-auto d-block">
            </div>
            <div class="col">
                <img src="/img/family.jpg" style="width: 100%;" class="mb-5 rounded mx-auto d-block">
            </div>
        </div>
